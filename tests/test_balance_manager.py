    ...
    def test_calculate_heating_costs_two_steps_external_sell(self):
        ...
        bids = [
            ...
            NetBidWithAcceptanceStatus(self.some_datetime, Action.BUY, Resource.HEATING, 4, math.inf, "Buyer2", False,
                                       4, None),
            NetBidWithAcceptanceStatus(self.some_datetime, Action.SELL, Resource.HEATING, 9, 0, "Seller", False,
                                       9, 0.0)]
