...
from tradingplatformpoc.app.app_functions import config_data_json_keys
...
class TestAppFunctions(TestCase):
    ...
    def test_config_data_json_screening(self):
        ...
        mock_json = {'Unknown': {}}
        self.assertIsNotNone(config_data_json_keys(mock_json))

    def test_config_data_json_keys(self):
        ...
        self.assertIsNotNone(config_data_json_keys(mock_json))
        mock_json = {'AreaInfo': {}, 'Agents': [{}]}
        self.assertIsNone(config_data_json_keys(mock_json))
        mock_json = {'MockDataConstants': {}, 'Agents': [{}]}
        self.assertIsNone(config_data_json_keys(mock_json))
        mock_json = {'Agents': {}}
        self.assertIsNotNone(config_data_json_keys(mock_json))
