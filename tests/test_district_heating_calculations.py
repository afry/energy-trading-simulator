...
class Test(TestCase):
    ...
    def test_estimate_district_heating_price_jan(self):
        self.assertAlmostEqual(1.311891744, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 1, 1)))

    def test_estimate_district_heating_price_feb(self):
        self.assertAlmostEqual(1.322548426, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 2, 1)))

    def test_estimate_district_heating_price_mar(self):
        self.assertAlmostEqual(0.649462366, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 3, 1)))

    def test_estimate_district_heating_price_apr(self):
        self.assertAlmostEqual(0.652777777, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 4, 1)))

    def test_estimate_district_heating_price_may(self):
        self.assertAlmostEqual(0.429462366, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 5, 1)))

    def test_estimate_district_heating_price_jun(self):
        self.assertAlmostEqual(0.432777777, DistrictHeatingPrice.estimate_district_heating_price(
            datetime.datetime(2019, 6, 1)))

    def test_estimate_district_heating_price_july(self):
        self.assertAlmostEqual(0.429462365, DistrictHeatingPrice.estimate_district_heating_price(
    ...
    def test_estimate_district_heating_price_oct(self):
        self.assertAlmostEqual(0.649462365, DistrictHeatingPrice.estimate_district_heating_price(
