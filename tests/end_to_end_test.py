...
from tradingplatformpoc import main
...
class Test(TestCase):
    ...
    def test(self):
        clearing_prices, all_trades, all_extra_costs = main.run_trading_simulations()
        ...
        for period in clearing_prices.keys():
            ...
            agents_who_traded = set([x.source for x in trades_for_period])
            for agent in agents_who_traded:
