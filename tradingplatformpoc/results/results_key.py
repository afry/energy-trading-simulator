...
class ResultsKey(Enum):
    ...
    SAVING_ABS_NET = "Saving by using local market, after taking penalties into account [SEK]"
    SAVING_REL_NET = "Saving by using local market, after taking penalties into account [%]"
