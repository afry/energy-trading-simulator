...
class ResultsKey:
    ...
    SUM_LEC_EXPENDITURE = 'Total LEC energy expenditure [SEK]'
    ...
    LOCALLY_PRODUCED_ELECTRICITY = 'Locally produced electricity [kWh]'
    LOCALLY_PRODUCED_COOLING = 'Locally produced cooling [kWh]'
    LOCALLY_PRODUCED_HEATING = 'Locally produced heating [kWh]'
